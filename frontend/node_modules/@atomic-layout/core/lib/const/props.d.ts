...
declare type FlexboxDistributedAlignment = 'space-between' | 'space-around' | 'space-evenly' | 'stretch';
declare type FlexboxSelfAlignment = 'self-start' | 'self-end';
declare type FlexboxOverflowAlignment = 'safe center' | 'unsafe center';
export interface GenericProps {
     ...
     */
    align?: 'auto' | 'normal' | 'stretch' | FlexboxBasicAlignment | FlexboxBaselineAlignment | FlexboxSelfAlignment | FlexboxOverflowAlignment | CSSGlobalValues;
    /**
     * Aligns direct children as a group.
     * @css `align-items`
     * @see https://developer.mozilla.org/en-US/docs/Web/CSS/align-items
     */
    alignItems?: 'normal' | 'stretch' | FlexboxBasicAlignment | FlexboxBaselineAlignment | FlexboxSelfAlignment | FlexboxOverflowAlignment | CSSGlobalValues;
    /**
     * Distributes space around and between content items.
     * @css `align-content`
     * @see https://developer.mozilla.org/en-US/docs/Web/CSS/align-content
     */
    alignContent?: 'stretch' | FlexboxBasicAlignment | FlexboxBaselineAlignment | FlexboxDistributedAlignment | FlexboxOverflowAlignment | CSSGlobalValues;
    /**
     * Justifies a box inside its alignment container.
     * @css `justify-self`
     * @see https://developer.mozilla.org/en-US/docs/Web/CSS/justify-self
     */
    justify?: 'stretch' | FlexboxBasicAlignment | FlexboxBaselineAlignment | FlexboxSelfAlignment | FlexboxOverflowAlignment | CSSGlobalValues;
    /**
     * Justifies direct children.
     * @css `justify-items`
     * @see https://developer.mozilla.org/en-US/docs/Web/CSS/justify-items
     */
    justifyItems?: 'auto' | 'stretch' | FlexboxBasicAlignment | FlexboxSelfAlignment | FlexboxBaselineAlignment | FlexboxOverflowAlignment | CSSGlobalValues;
    /**
     * Justifies space between and around content items along the main axis.
     * @css `justify-content`
     * @see https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content
     */
    justifyContent?: 'normal' | 'stretch' | FlexboxBasicAlignment | FlexboxSelfAlignment | FlexboxDistributedAlignment | FlexboxOverflowAlignment;
    place?: 'auto' | 'normal' | CSSGlobalValues | FlexboxBasicAlignment | FlexboxBaselineAlignment;
    /**
     * Shorthand for `align-items` and `justify-items`.
     * @css `place-items`
     * @see https://developer.mozilla.org/en-US/docs/Web/CSS/place-items
     */
    placeItems?: 'auto' | 'normal' | FlexboxBasicAlignment | FlexboxSelfAlignment | FlexboxBaselineAlignment | CSSGlobalValues;
    /**
     * Shorthand for `align-content` and `justify-content`.
     * @css `place-content`
     * @see https://developer.mozilla.org/en-US/docs/Web/CSS/place-content
     */
    placeContent?: 'stretch' | FlexboxBasicAlignment | FlexboxBaselineAlignment | FlexboxDistributedAlignment | CSSGlobalValues;
    height?: Numeric;
    minHeight?: Numeric;
    maxHeight?: Numeric;
    width?: Numeric;
...
export declare type CompositionRenderProp = (areas: AreasMap) => React.ReactNode;
