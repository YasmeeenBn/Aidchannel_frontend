    ...
    impacts?.map((impact) => {
      nodes.push({
        ...
        ...{
          ...
          color: { border: "#BF40BF", background: not_impact_color },
    ...
    outcomes?.map((outcome) => {
      nodes.push({
        ...
        ...{
          ...
          color: {
            border: not_impact_color,
            background: not_impact_color,

            hover: {
              border: Color(not_impact_color)
                .darken(0.3)
                .hex(),
              background: Color(not_impact_color)
                .darken(0.2)
                .hex(),
            },
          },
